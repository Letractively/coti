...
<div id="content">
    ...
    <table class="table_form" align="center">
        <form name="f_usuario" method="POST" action="cadastra_user.php" >
            ...
            <tr>
                <td width="20%">Nome:</td>
                <td colspan="3"><input type="text" name="cadu_nome" size="60%" onkeypress="checaVazios(this.form, this.name);" /> </td> <!-- onBlur="checaVazios(this.value, cadu_nome)" -->
            </tr>

            <tr>
                <td width="20%">SIAPE:</td> <!--SIAPE: como não sei o algoritmo dos numeros siape-->
                <td><input id="cadu_login" type="text" name="cadu_login" size="50%" OnKeyPress="return SomenteNumero()" /></td><!-- onBlur="checaVazios(this.value, cadu_nome)" -->
            </tr>

            <tr>
                <td width="20%">Senha:</td>
                <td><input type="password" name="cadu_pass" onkeyup="mostra_seguranca_chave_img(this, this.name)" /> 
                    Segurança: 
            ...
            <tr>
                ...
                <td colspan="3"><input type="text" name="cadu_email" onBlur="validaEmail();" /></td>
            </tr>
            <tr>
                <td width="20%">Telefone:</td>
                <td><input type="text" name="cadu_tel" onBlur="ValidaTelefone(f_usuario.cadu_tel);" onKeyUp="mascara_telefone();" maxlength="14" value="(" />
                <br />Apenas n&uacute;meros
                </td><!-- onBlur="checaVazios(this.value, cadu_nome)" -->
            ...
            <tr>
                <td colspan="4" align="right">
                   <!-- <input type="submit" name="cadusuario_novo" value="Novo" style="font-weight:bold" onClick="HabilitaUser()" /> &nbsp;
                    ...
                    <!--<input type="submit" name="cadusuario_excluir" value="Excluir" style="font-weight:bold" />-->
                </td>
            </tr>
  </table>
</form>
